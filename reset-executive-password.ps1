# Restablece contraseña de usuario ejecutivo (app Capture) por email
# Uso: .\reset-executive-password.ps1 benjamin@tu-dominio.com MiNuevaClave1
...
node scripts/reset-executive-password.js $Email $NuevaClave
